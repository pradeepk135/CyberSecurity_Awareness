...
function SignInScreen({ onSignIn, userName, userEmail }) {
      ...
      <div style={{
        ...
        <div className="fade-in" style={{
          ...
          <p style={{ fontSize: 13, color: "var(--ink-500)", marginTop: 6, marginBottom: 22, lineHeight: 1.5 }}>
            Use your Zentiti work account to access the training portal.
          </p>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 12.5, color: "var(--ink-700)", lineHeight: 1.5 }}>
              Only <strong>@synersys.com</strong> email addresses are permitted. Personal Google accounts will be rejected.
            </div>
          </div>
