...
import { MODULES } from '../data.jsx';
import { Icon, PrimaryButton, SecondaryButton, ProgressBar, Pill, PageHeader } from '../components.jsx';
...
function VideoPlayer({ module: m, progress, playing, onPlayPause, onSeek, activeChapter }) {
  const totalSec = m.duration * 60;
  ...
  return (
    <div style={{
      ...
      <div style={{
        aspectRatio: "16 / 9",
        position: "relative",
        background: `radial-gradient(ellipse at 30% 30%, #173a66 0%, #0b1c33 60%, #061021 100%)`,
        display: "flex",
        alignItems: "center",
        ...
        <div style={{ position: "relative", textAlign: "center", color: "rgba(255,255,255,0.92)" }}>
          ...
          <div style={{ fontSize: 13, color: "rgba(255,255,255,0.4)", marginTop: 12, fontFamily: "'IBM Plex Mono', monospace" }}>
            [ Video placeholder · {m.chapters[activeChapter].duration} ]
          </div>
        </div>
