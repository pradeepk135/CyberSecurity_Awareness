...
const MODULES = [
  {
    ...
    summary: "How everyday actions protect company, our customers, and you personally.",
    duration: 12,
    videoUrl: "/videos/video-01.mp4",
    chapters: [
      { id: "1.1", title: "The cost of a breach", duration: "3:24" },
      { id: "1.2", title: "Your role in the chain", duration: "4:10" },
      { id: "1.3", title: "Regulatory context", duration: "4:26" },
    ],
    transcript: [
  ...
  },
  {
    ...
    summary: "Spotting and reporting deceptive emails, calls, and messages.",
    duration: 16,
    videoUrl: "/videos/video-03.mp4",
    chapters: [
      { id: "3.1", title: "Anatomy of a phishing email", duration: "5:30" },
      { id: "3.2", title: "Smishing and vishing", duration: "5:00" },
      { id: "3.3", title: "Reporting suspicious messages", duration: "5:30" },
    ],
    knowledgeCheck: [
      {
  ...
  },
  {
    ...
    duration: 11,
    videoUrl: "/videos/module-04-passwords-account-security.mp4",
    chapters: [
      { id: "4.1", title: "Anatomy of a strong passphrase", duration: "3:40" },
      { id: "4.2", title: "Multi-factor authentication", duration: "3:55" },
      { id: "4.3", title: "Using the company password manager", duration: "3:25" },
    ],
    knowledgeCheck: [
      {
...
const TEAM = [
  { name: "Amelia Carter",   role: "Senior Analyst",      progress: 100, status: "Complete",    score: 92, started: "Apr 28", due: "May 14", modulesCompleted: 8 },
  { name: "Jonas Beck",      role: "Operations Lead",     progress: 100, status: "Complete",    score: 88, started: "Apr 28", due: "May 14", modulesCompleted: 8 },
  { name: "Priya Raman",     role: "Account Manager",     progress: 75,  status: "In progress", score: null, started: "Apr 29", due: "May 14", modulesCompleted: 6 },
  { name: "Marcus Lindqvist",role: "Engineer II",         progress: 62,  status: "In progress", score: null, started: "Apr 29", due: "May 14", modulesCompleted: 5 },
  { name: "Sara Okonkwo",    role: "Engineer I",          progress: 38,  status: "In progress", score: null, started: "Apr 30", due: "May 14", modulesCompleted: 3 },
  { name: "Daniel Vogel",    role: "Customer Success",    progress: 25,  status: "In progress", score: null, started: "Apr 30", due: "May 14", modulesCompleted: 2 },
  { name: "Hina Patel",      role: "Finance Analyst",     progress: 12,  status: "Started",     score: null, started: "Apr 30", due: "May 14", modulesCompleted: 1 },
  { name: "Robert Hassan",   role: "Account Executive",   progress: 0,   status: "Not started", score: null, started: null,     due: "May 14", modulesCompleted: 0 },
  { name: "Yui Tanaka",      role: "Designer",            progress: 0,   status: "Not started", score: null, started: null,     due: "May 14", modulesCompleted: 0 },
];

export { MODULES, ASSESSMENT_QUESTIONS, TEAM };
